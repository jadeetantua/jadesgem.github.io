...
<body>
    <div class="container">
        <form action="login.php" method="post">
                ...
                if (mysqli_stmt_prepare($stmt, $sql)) {
                    ...
                    if (mysqli_num_rows($result) == 1) {
                        ...
                        if (password_verify($password, $row["password"])) {
                            ...
                            header("location: Portfolio.php"); // Redirect to a success page after login
                            die();
                        } else {
            ...
            <div class="form-btn">
                <input type="submit" value="Login" name="submit" class="btn btn-primary"><a href="Portfolio"></a>
            </div>
        </form>
